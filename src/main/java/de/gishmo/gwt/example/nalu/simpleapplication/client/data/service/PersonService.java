...
import de.gishmo.gwt.example.nalu.simpleapplication.client.data.model.dto.Address;
...
public class PersonService {
  ...
  public List<Person> getFromServer(PersonSearch search) {
    List<Person> list = new ArrayList<Person>();
    //new PersonRestService_RestServiceModel();
    //PersonRestService srv = new PersonRestService_RestServiceModel();
    return list;
  }
